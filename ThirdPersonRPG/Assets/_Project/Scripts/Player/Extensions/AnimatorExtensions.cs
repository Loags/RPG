...
namespace LB
{
    ...
    public static class AnimatorExtensions
    {
        ...
        {
            AnimatorTrigger parsedTrigger = (AnimatorTrigger)Enum.Parse(typeof(AnimatorTrigger), trigger);
        ...
        public static void SetWeapons(this Animator animator, AnimatorWeapon animatorWeapon, int weaponSwitch,
            Weapon leftWeapon, Weapon rightWeapon, Side weaponSide)
        {
            {
    ...
    /// <summary>
    /// Animator representation of the weapon switch state.
    /// </summary>
    public enum AnimatorWeapon
    {
        UNARMED = 0,
        MELEE = 1 // Renamed from TWOHANDSWORD
    }
}