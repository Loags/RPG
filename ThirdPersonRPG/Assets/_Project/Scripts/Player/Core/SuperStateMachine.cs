...
public class SuperStateMachine : MonoBehaviour
{
    ...
    private Dictionary<Enum, Dictionary<string, Delegate>>
        _cache = new Dictionary<Enum, Dictionary<string, Delegate>>();
    ...
    private T ConfigureDelegate<T>(string methodRoot, T Default) where T : class
    {
        ...
        {
            System.Reflection.MethodInfo mtd = GetType().GetMethod(state.currentState.ToString() + "_" + methodRoot,
